...
sed -i 's/192.168.1./192.168.3./g' package/base-files/luci2/bin/config_generate
sed -i 's/192.168.1./192.168.3./g' package/base-files/Makefile
sed -i 's/192.168.1./192.168.3./g' package/base-files/image-config.in
